...
import edu.javavt16.dao.jpa.CarBrandDAOJpaImpl;
import edu.javavt16.dao.jpa.CarModelDAOJpaImpl;
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[] {"edu.javavt16.model"});
